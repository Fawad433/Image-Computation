...
class App:    
    ...
    def __init__(self, video_src, paused = False):
        ...
        self.trackers = []
        self.paused = paused
        self.cap = cv2.VideoCapture('Another.mp4')
        ...
        while(1):
            ...
            if fcount == 15:
                ...
                #for dat in self.datastatic:
                	#qf.write('|'.join(list(map(str,dat))) + '\n')
...
#                print(index_dynamic)
                ...
                print("In 15th frames {} is moving towards {}".format(self.datadynamic[index_dynamic,5], self.datastatic[index_static,5]))
                fcount = 0;
            if key == ord("q"):
